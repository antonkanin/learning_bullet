...
/*REM*		GameObject* BulletOpenGLApplication::CreateGameObject(btCollisionShape* pShape, const float &mass, const btVector3 &color, const btVector3 &initialPosition, const btQuaternion &initialRotation) { **/
/*ADD*/		GameObject* BulletOpenGLApplication::CreateGameObject(btCollisionShape* pShape, const float &mass, const btVector3 &color, const btVector3 &initialPosition, short group, short mask, const btQuaternion &initialRotation) {
...
/*REM*		m_pWorld->addRigidBody(pObject->GetRigidBody()); **/
/*ADD*/		m_pWorld->addRigidBody(pObject->GetRigidBody(), group, mask);
	}
	return pObject;
}
