...
/*ADD*/		// create a vertex cloud defining a square-based pyramid
/*ADD*/		btVector3 points[5] = {btVector3(-0.5,1,1),
/*ADD*/			btVector3(-0.5,1,-1),
/*ADD*/			btVector3(-0.5,-1,1),
/*ADD*/			btVector3(-0.5,-1,-1),
/*ADD*/			btVector3(1,0,0)};
/*ADD*/		// create our convex hull
/*ADD*/		btConvexHullShape* pShape = new btConvexHullShape(&points[0].getX(),5);
/*ADD*/		// initialize the object as a polyhedron
/*ADD*/		pShape->initializePolyhedralFeatures();
/*ADD*/		// create the game object using our convex hull shape
/*ADD*/		CreateGameObject(pShape, 1.0, btVector3(1,1,1), btVector3(5, 15, 0));
